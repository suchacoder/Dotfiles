...
imgpath = "/home/$USER/Music/covers/500/"

# Path where 'artist-only' images can be found
artistimgpath = "/home/$USER/Music/covers/500/"

# Image displayed when no image found
noimg = "/home/$USER/Music/covers/500/nocover.jpg"

# Cover displayed by conky
cover = "/home/$USER/Music/covers/500/cover.jpg"
...
if album == "":
    ...
    if os.path.exists("/tmp/nowplaying") and os.path.exists("/home/$USER/Music/covers/500/cover.jpg"):
